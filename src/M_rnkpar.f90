...
!>
!!##NAME
!!    rnkpar(3f) - [orderpack:RANK:PARTIAL] partially ranks an array,
!!                 up to order N (where N is the number of sorted elements
!!                 to return) (QuickSort-like)
!!
!!##SYNOPSIS
!!
...
!!##LICENSE
!!    CC0-1.0
Subroutine real64_rnkpar (XDONT, IRNGT, NORD)
...
Subroutine real32_rnkpar (XDONT, IRNGT, NORD)
!!__________________________________________________________
...
Subroutine int32_rnkpar (XDONT, IRNGT, NORD)
!!__________________________________________________________
