...
inspar(3f) -\/ \mbox{[}orderpack\+:\+S\+O\+RT\+:P\+A\+R\+T\+I\+AL\mbox{]} partially sorts an array (Insertion Sort, generally for small or nearly sorted arrays)\hypertarget{namespacem__inspar_autotoc_md33}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__inspar_autotoc_md33}
