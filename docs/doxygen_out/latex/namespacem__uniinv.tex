...
\begin{DoxyCompactItemize}
\item 
subroutine \mbox{\hyperlink{namespacem__uniinv_a9fe847fa5840c273c93d3aa4d22515ef}{real64\+\_\+uniinv}} (I\+N\+V\+A\+LS, I\+G\+O\+E\+ST)
\item 
real(kind=real64) function \mbox{\hyperlink{namespacem__uniinv_a869e1708aa9b20de9eed1b16d8184479}{real64\+\_\+nearless}} (X\+V\+AL)
\item 
subroutine \mbox{\hyperlink{namespacem__uniinv_af00db16302574ef746e2489b6ce04386}{real32\+\_\+uniinv}} (I\+N\+V\+A\+LS, I\+G\+O\+E\+ST)
\item 
real(kind=real32) function \mbox{\hyperlink{namespacem__uniinv_a897a2688266af18fc6b1f1cc134c3286}{real32\+\_\+nearless}} (X\+V\+AL)
\item 
subroutine \mbox{\hyperlink{namespacem__uniinv_aca1ebd75d3ce3eee959e100264abfb3b}{int32\+\_\+uniinv}} (I\+N\+V\+A\+LS, I\+G\+O\+E\+ST)
\item 
integer(kind=int32) function \mbox{\hyperlink{namespacem__uniinv_a4122a23d616699a990897245cdd1c54c}{int32\+\_\+nearless}} (X\+V\+AL)
\item 
subroutine \mbox{\hyperlink{namespacem__uniinv_a13f8cba9744a7b70c43c37d057c904ac}{f\+\_\+char\+\_\+uniinv}} (I\+N\+V\+A\+LS, I\+G\+O\+E\+ST)
\item 
...
\end{DoxyCode}
\mbox{\Hypertarget{namespacem__uniinv_a13f8cba9744a7b70c43c37d057c904ac}\label{namespacem__uniinv_a13f8cba9744a7b70c43c37d057c904ac}} 
...
\end{DoxyCode}
\mbox{\Hypertarget{namespacem__uniinv_aca1ebd75d3ce3eee959e100264abfb3b}\label{namespacem__uniinv_aca1ebd75d3ce3eee959e100264abfb3b}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+uniinv\+::int32\+\_\+uniinv (\begin{DoxyParamCaption}\item[{integer (kind=int32), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, dimension (\+:), intent(out)}]{I\+G\+O\+E\+ST }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{namespacem__uniinv_af00db16302574ef746e2489b6ce04386}\label{namespacem__uniinv_af00db16302574ef746e2489b6ce04386}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+uniinv\+::real32\+\_\+uniinv (\begin{DoxyParamCaption}\item[{real (kind=real32), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, dimension (\+:), intent(out)}]{I\+G\+O\+E\+ST }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{namespacem__uniinv_a9fe847fa5840c273c93d3aa4d22515ef}\label{namespacem__uniinv_a9fe847fa5840c273c93d3aa4d22515ef}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+uniinv\+::real64\+\_\+uniinv (\begin{DoxyParamCaption}\item[{real (kind=real64), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, dimension (\+:), intent(out)}]{I\+G\+O\+E\+ST }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

\hypertarget{namespacem__uniinv_autotoc_md143}{}\doxysubsubsection{N\+A\+ME}\label{namespacem__uniinv_autotoc_md143}
Rank\+\_\+\+Decreasing(3f) -\/ \mbox{[}orderpack\+:\+R\+A\+NK\+:U\+N\+I\+Q\+UE\mbox{]} ranks an array in decreasing order, with duplicate entries assigned the same rank(\+Merge\+Sort)\hypertarget{namespacem__uniinv_autotoc_md144}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__uniinv_autotoc_md144}
...
\end{DoxyVerb}
\hypertarget{namespacem__uniinv_autotoc_md145}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{namespacem__uniinv_autotoc_md145}
...
\end{DoxyVerb}
\hypertarget{namespacem__uniinv_autotoc_md146}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__uniinv_autotoc_md146}
I\+N\+V\+A\+LS array to rank I\+G\+O\+E\+ST returned rank array\hypertarget{namespacem__uniinv_autotoc_md147}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{namespacem__uniinv_autotoc_md147}
Sample program\+:
...
Original\+: 11 11 22 11 33 33 22 33 33 Number of indices to sort\+: 9 Returned Indices\+: 1 1 2 1 3 3 2 3 3 Number of unique indices \+: 3 Sorted unique values\+: 11 22 33 count of occurrences\+: 3 2 4\hypertarget{namespacem__uniinv_autotoc_md148}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{namespacem__uniinv_autotoc_md148}
Michel Olagnon, 2000-\/2012 \hypertarget{namespacem__uniinv_autotoc_md149}{}\doxysubsubsection{M\+A\+I\+N\+T\+A\+I\+N\+ER}\label{namespacem__uniinv_autotoc_md149}
John Urban, 2022.\+04.\+16 \hypertarget{namespacem__uniinv_autotoc_md150}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{namespacem__uniinv_autotoc_md150}
C\+C0-\/1.\+0 
\begin{DoxyCode}{0}
