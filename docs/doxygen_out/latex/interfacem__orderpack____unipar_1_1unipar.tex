...
\item 
subroutine \mbox{\hyperlink{interfacem__orderpack____unipar_1_1unipar_a4d4e2d3c3a6a9c08b3e8d848281d379e}{int16\+\_\+unipar}} (I\+N\+V\+A\+LS, I\+R\+N\+GT, N\+O\+RD)
\item 
...
\item 
subroutine \mbox{\hyperlink{interfacem__orderpack____unipar_1_1unipar_a2a810f2ea0b65aa49f6db3f0859d0fa1}{int64\+\_\+unipar}} (I\+N\+V\+A\+LS, I\+R\+N\+GT, N\+O\+RD)
...
program demo\+\_\+prank\+\_\+unique ! ranks array, removing duplicates use M\+\_\+orderpack, only \+: prank\+\_\+unique implicit none character(len=$\ast$),parameter \+:: g=\textquotesingle{}($\ast$(g0,1x))\textquotesingle{} integer,allocatable \+:: I\+N\+V\+A\+L\+S(\+:) integer,allocatable \+:: irngt(\+:) integer \+:: nord ! write($\ast$,g)\textquotesingle{}If enough values are unique, will return N\+O\+RD indices\textquotesingle{} I\+N\+V\+A\+LS=\mbox{[}10,5,7,1,4,5,6,8,9,10,1\mbox{]} nord=5 call printme() ! write($\ast$,g)\textquotesingle{}If not enough values are unique, will change N\+O\+RD\textquotesingle{} I\+N\+V\+A\+LS=\mbox{[}-\/1,0,-\/1,0,-\/1,0,-\/1\mbox{]} nord=5 if(allocated(irngt))deallocate(irngt) allocate(irngt(nord)) call printme() ! contains subroutine printme() write($\ast$,g)\textquotesingle{}O\+R\+I\+G\+I\+N\+AL\+:\textquotesingle{},I\+N\+V\+A\+LS write($\ast$,g)\textquotesingle{}N\+U\+M\+B\+ER OF I\+N\+D\+I\+C\+ES TO S\+O\+RT\+:\textquotesingle{},nord if(allocated(irngt))deallocate(irngt) allocate(irngt(nord)) call prank\+\_\+unique(\+I\+N\+V\+A\+L\+S,irngt,nord) write($\ast$,g)\textquotesingle{}N\+U\+M\+B\+ER OF I\+N\+D\+I\+C\+ES R\+E\+T\+U\+R\+N\+ED\+:\textquotesingle{},nord write($\ast$,g)\textquotesingle{}R\+E\+T\+U\+R\+N\+ED I\+N\+D\+I\+C\+ES\+:\textquotesingle{},irngt(\+:nord) write($\ast$,g)nord,\textquotesingle{}S\+M\+A\+L\+L\+E\+ST U\+N\+I\+Q\+UE V\+A\+L\+U\+ES\+:\textquotesingle{},I\+N\+V\+A\+L\+S(irngt(\+:nord)) end subroutine end program demo\+\_\+prank\+\_\+unique
...
\mbox{\Hypertarget{interfacem__orderpack____unipar_1_1unipar_a4d4e2d3c3a6a9c08b3e8d848281d379e}\label{interfacem__orderpack____unipar_1_1unipar_a4d4e2d3c3a6a9c08b3e8d848281d379e}} 
\index{m\_orderpack\_\_unipar::unipar@{m\_orderpack\_\_unipar::unipar}!int16\_unipar@{int16\_unipar}}
\index{int16\_unipar@{int16\_unipar}!m\_orderpack\_\_unipar::unipar@{m\_orderpack\_\_unipar::unipar}}
\doxysubsubsection{\texorpdfstring{int16\_unipar()}{int16\_unipar()}}
{\footnotesize\ttfamily subroutine m\+\_\+orderpack\+\_\+\+\_\+unipar\+::unipar\+::int16\+\_\+unipar (\begin{DoxyParamCaption}\item[{integer (kind=int16), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, dimension (\+:), intent(out)}]{I\+R\+N\+GT,  }\item[{integer, intent(inout)}]{N\+O\+RD }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__orderpack____unipar_1_1unipar_a2a810f2ea0b65aa49f6db3f0859d0fa1}\label{interfacem__orderpack____unipar_1_1unipar_a2a810f2ea0b65aa49f6db3f0859d0fa1}} 
\index{m\_orderpack\_\_unipar::unipar@{m\_orderpack\_\_unipar::unipar}!int64\_unipar@{int64\_unipar}}
\index{int64\_unipar@{int64\_unipar}!m\_orderpack\_\_unipar::unipar@{m\_orderpack\_\_unipar::unipar}}
\doxysubsubsection{\texorpdfstring{int64\_unipar()}{int64\_unipar()}}
{\footnotesize\ttfamily subroutine m\+\_\+orderpack\+\_\+\+\_\+unipar\+::unipar\+::int64\+\_\+unipar (\begin{DoxyParamCaption}\item[{integer (kind=int64), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, dimension (\+:), intent(out)}]{I\+R\+N\+GT,  }\item[{integer, intent(inout)}]{N\+O\+RD }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
