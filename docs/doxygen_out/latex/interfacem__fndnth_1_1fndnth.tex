...
so O\+R\+D\+E\+R\+V\+A\+L\+\_\+\+S\+P\+E\+C\+I\+A\+L(3f) should be used when I\+N\+O\+RD is small and I\+N\+V\+A\+LS is likely to be a random array, otherwise consider using I\+N\+D\+N\+T\+H(3) or V\+A\+L\+N\+T\+H(3).\hypertarget{namespacem__fndnth_autotoc_md11}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{namespacem__fndnth_autotoc_md11}
