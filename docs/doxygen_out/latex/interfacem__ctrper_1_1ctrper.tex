...
\item 
subroutine \mbox{\hyperlink{interfacem__ctrper_1_1ctrper_a51b0cc9aad64f432043fbdad94503ce1}{real64\+\_\+ctrper}} (I\+N\+O\+U\+T\+V\+A\+LS, C\+L\+O\+S\+E\+N\+E\+SS)
\item 
subroutine \mbox{\hyperlink{interfacem__ctrper_1_1ctrper_ac7d3cb63528c4c23db92d0c9ce7f6fab}{real32\+\_\+ctrper}} (I\+N\+O\+U\+T\+V\+A\+LS, C\+L\+O\+S\+E\+N\+E\+SS)
\item 
subroutine \mbox{\hyperlink{interfacem__ctrper_1_1ctrper_aa6a520ee67c000553e31ffee29e04546}{int32\+\_\+ctrper}} (I\+N\+O\+U\+T\+V\+A\+LS, C\+L\+O\+S\+E\+N\+E\+SS)
\item 
subroutine \mbox{\hyperlink{interfacem__ctrper_1_1ctrper_a64f66595c3a35a92a3c0a0be7df391f9}{f\+\_\+char\+\_\+ctrper}} (I\+N\+O\+U\+T\+V\+A\+LS, C\+L\+O\+S\+E\+N\+E\+SS)
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md0}{}\doxysubsubsection{N\+A\+ME}\label{interfacem__ctrper_1_1ctrper_autotoc_md0}
perturb(3f) -\/ \mbox{[}orderpack\+:P\+E\+R\+M\+U\+T\+A\+T\+I\+ON\mbox{]} generate a random permutation of an array leaving elements close to initial locations\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md1}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{interfacem__ctrper_1_1ctrper_autotoc_md1}
...
\end{DoxyVerb}
\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md2}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{interfacem__ctrper_1_1ctrper_autotoc_md2}
...
Internally, the routine creates a real array of the indices of I\+N\+O\+U\+T\+V\+A\+L\+S() perturbed by random values that are based on the size of C\+L\+O\+S\+E\+N\+E\+SS. The new array is then ranked using R\+A\+N\+K(3f) and the resulting index is used to permute the input array.\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md3}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{interfacem__ctrper_1_1ctrper_autotoc_md3}
I\+N\+O\+U\+T\+V\+A\+LS Array of values to perturb. C\+L\+O\+S\+E\+N\+E\+SS Proportion of closeness, constrained to the range 0.\+0(no change) to 1.\+0(fully random).\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md4}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{interfacem__ctrper_1_1ctrper_autotoc_md4}
Sample program\+:
...
count unchanged perturbed random 1 2000 1980 80 2 1990 1990 580 3 1980 1890 1690 4 1970 1900 1340 5 1960 1920 1260 6 1950 1950 1220 7 1940 1880 160 8 1930 1960 1620 9 1920 1860 540 10 1910 1930 1300 11 1900 1940 1190 . . . . . . . . . . . . . . . . 189 120 80 1200 190 110 150 800 191 100 120 1430 192 90 170 1410 193 80 140 370 194 70 90 1720 195 60 10 830 196 50 100 1670 197 40 20 470 198 30 70 1020 199 20 60 1540 200 10 30 1810 Original.................\+: a be car dam fan gas egg Perturbed ...............\+: a be gas dam fan car egg\hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md5}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{interfacem__ctrper_1_1ctrper_autotoc_md5}
Michel Olagnon, 2000-\/2012 \hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md6}{}\doxysubsubsection{M\+A\+I\+N\+T\+A\+I\+N\+ER}\label{interfacem__ctrper_1_1ctrper_autotoc_md6}
John Urban, 2022.\+04.\+16 \hypertarget{interfacem__ctrper_1_1ctrper_autotoc_md7}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{interfacem__ctrper_1_1ctrper_autotoc_md7}
C\+C0-\/1.\+0 

\doxysubsection{Member Function/\+Subroutine Documentation}
\mbox{\Hypertarget{interfacem__ctrper_1_1ctrper_a64f66595c3a35a92a3c0a0be7df391f9}\label{interfacem__ctrper_1_1ctrper_a64f66595c3a35a92a3c0a0be7df391f9}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+ctrper\+::ctrper\+::f\+\_\+char\+\_\+ctrper (\begin{DoxyParamCaption}\item[{character (kind=\mbox{\hyperlink{namespacem__ctrper_a2549d1e9c7e73b3c0bcc27afe267ecef}{f\+\_\+char}},len=$\ast$), dimension (\+:), intent(inout)}]{I\+N\+O\+U\+T\+V\+A\+LS,  }\item[{real, intent(in)}]{C\+L\+O\+S\+E\+N\+E\+SS }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__ctrper_1_1ctrper_aa6a520ee67c000553e31ffee29e04546}\label{interfacem__ctrper_1_1ctrper_aa6a520ee67c000553e31ffee29e04546}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+ctrper\+::ctrper\+::int32\+\_\+ctrper (\begin{DoxyParamCaption}\item[{integer (kind=int32), dimension (\+:), intent(inout)}]{I\+N\+O\+U\+T\+V\+A\+LS,  }\item[{real, intent(in)}]{C\+L\+O\+S\+E\+N\+E\+SS }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__ctrper_1_1ctrper_ac7d3cb63528c4c23db92d0c9ce7f6fab}\label{interfacem__ctrper_1_1ctrper_ac7d3cb63528c4c23db92d0c9ce7f6fab}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+ctrper\+::ctrper\+::real32\+\_\+ctrper (\begin{DoxyParamCaption}\item[{real (kind=real32), dimension (\+:), intent(inout)}]{I\+N\+O\+U\+T\+V\+A\+LS,  }\item[{real, intent(in)}]{C\+L\+O\+S\+E\+N\+E\+SS }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__ctrper_1_1ctrper_a51b0cc9aad64f432043fbdad94503ce1}\label{interfacem__ctrper_1_1ctrper_a51b0cc9aad64f432043fbdad94503ce1}} 
...
{\footnotesize\ttfamily subroutine m\+\_\+ctrper\+::ctrper\+::real64\+\_\+ctrper (\begin{DoxyParamCaption}\item[{real (kind=real64), dimension (\+:), intent(inout)}]{I\+N\+O\+U\+T\+V\+A\+LS,  }\item[{real, intent(in)}]{C\+L\+O\+S\+E\+N\+E\+SS }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
