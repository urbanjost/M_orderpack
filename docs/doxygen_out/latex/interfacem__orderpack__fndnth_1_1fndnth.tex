\hypertarget{interfacem__orderpack__fndnth_1_1fndnth}{}\doxysection{m\+\_\+orderpack\+\_\+fndnth\+::fndnth Interface Reference}
\label{interfacem__orderpack__fndnth_1_1fndnth}\index{m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}}
\doxysubsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
real(kind=real64) function \mbox{\hyperlink{interfacem__orderpack__fndnth_1_1fndnth_a93873ba45aa5b6bbd7c3ed0abd4e25a1}{real64\+\_\+fndnth}} (I\+N\+V\+A\+LS, I\+N\+O\+RD)
\item 
real(kind=real32) function \mbox{\hyperlink{interfacem__orderpack__fndnth_1_1fndnth_ac0883361576ac76c61f9d7f2bd8c8179}{real32\+\_\+fndnth}} (I\+N\+V\+A\+LS, I\+N\+O\+RD)
\item 
integer(kind=int32) function \mbox{\hyperlink{interfacem__orderpack__fndnth_1_1fndnth_a6fb13446e5ecbaec07c277a3289c38a0}{int32\+\_\+fndnth}} (I\+N\+V\+A\+LS, I\+N\+O\+RD)
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md26}{}\doxysubsubsection{N\+A\+ME}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md26}
orderval\+\_\+special(3f) -\/ \mbox{[}M\+\_\+orderpack\+:F\+R\+A\+C\+T\+I\+LE\mbox{]} Return V\+A\+L\+UE of Nth ordered element of array (Insert\+Sort-\/like)\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md27}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md27}
...
\end{DoxyVerb}
\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md28}{}\doxysubsubsection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md28}
...
so O\+R\+D\+E\+R\+V\+A\+L\+\_\+\+S\+P\+E\+C\+I\+A\+L(3f) should be used when I\+N\+O\+RD is small and I\+N\+V\+A\+LS is likely to be a random array, otherwise consider using O\+R\+D\+E\+R\+L\+O\+C(3f) or O\+R\+D\+E\+R\+V\+A\+L(3f).\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md29}{}\doxysubsubsection{O\+P\+T\+I\+O\+NS}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md29}
I\+N\+V\+A\+LS input array of values I\+N\+O\+RD specify Nth value of sorted I\+N\+V\+A\+LS array to return, from 1 to size(\+I\+N\+V\+A\+L\+S). \hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md30}{}\doxysubsubsection{R\+E\+T\+U\+R\+NS}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md30}
O\+R\+D\+E\+R\+V\+A\+L\+\_\+\+S\+P\+E\+C\+I\+AL returned value\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md31}{}\doxysubsubsection{E\+X\+A\+M\+P\+L\+ES}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md31}
Sample program\+:
...
O\+R\+I\+G\+I\+N\+AL\+: 80 70 30 40 -\/50 60 20 10 minval -\/50 -\/50 maxval 80 80 median 30 30 inord= 3 fractile= 20 O\+R\+I\+G\+I\+N\+AL\+: 80 70 30 40 -\/50 60 20 10 1, -\/50 2, 10 3, 20 4, 30 5, 40 6, 60 7, 70 8, 80\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md32}{}\doxysubsubsection{S\+E\+E A\+L\+SO}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md32}
\begin{DoxyVerb}ORDERLOC(3f), ORDERVAL(3f)
\end{DoxyVerb}
\hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md33}{}\doxysubsubsection{A\+U\+T\+H\+OR}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md33}
Michel Olagnon -\/ Aug. 2000 \hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md34}{}\doxysubsubsection{M\+A\+I\+N\+T\+A\+I\+N\+ER}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md34}
John Urban, 2022.\+04.\+16 \hypertarget{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md35}{}\doxysubsubsection{L\+I\+C\+E\+N\+SE}\label{interfacem__orderpack__fndnth_1_1fndnth_autotoc_md35}
C\+C0-\/1.\+0 

\doxysubsection{Member Function/\+Subroutine Documentation}
\mbox{\Hypertarget{interfacem__orderpack__fndnth_1_1fndnth_a6fb13446e5ecbaec07c277a3289c38a0}\label{interfacem__orderpack__fndnth_1_1fndnth_a6fb13446e5ecbaec07c277a3289c38a0}} 
\index{m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}!int32\_fndnth@{int32\_fndnth}}
\index{int32\_fndnth@{int32\_fndnth}!m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}}
\doxysubsubsection{\texorpdfstring{int32\_fndnth()}{int32\_fndnth()}}
{\footnotesize\ttfamily integer (kind=int32) function m\+\_\+orderpack\+\_\+fndnth\+::fndnth\+::int32\+\_\+fndnth (\begin{DoxyParamCaption}\item[{integer (kind=int32), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, intent(in)}]{I\+N\+O\+RD }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__orderpack__fndnth_1_1fndnth_ac0883361576ac76c61f9d7f2bd8c8179}\label{interfacem__orderpack__fndnth_1_1fndnth_ac0883361576ac76c61f9d7f2bd8c8179}} 
\index{m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}!real32\_fndnth@{real32\_fndnth}}
\index{real32\_fndnth@{real32\_fndnth}!m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}}
\doxysubsubsection{\texorpdfstring{real32\_fndnth()}{real32\_fndnth()}}
{\footnotesize\ttfamily real (kind=real32) function m\+\_\+orderpack\+\_\+fndnth\+::fndnth\+::real32\+\_\+fndnth (\begin{DoxyParamCaption}\item[{real (kind=real32), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, intent(in)}]{I\+N\+O\+RD }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{interfacem__orderpack__fndnth_1_1fndnth_a93873ba45aa5b6bbd7c3ed0abd4e25a1}\label{interfacem__orderpack__fndnth_1_1fndnth_a93873ba45aa5b6bbd7c3ed0abd4e25a1}} 
\index{m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}!real64\_fndnth@{real64\_fndnth}}
\index{real64\_fndnth@{real64\_fndnth}!m\_orderpack\_fndnth::fndnth@{m\_orderpack\_fndnth::fndnth}}
\doxysubsubsection{\texorpdfstring{real64\_fndnth()}{real64\_fndnth()}}
{\footnotesize\ttfamily real (kind=real64) function m\+\_\+orderpack\+\_\+fndnth\+::fndnth\+::real64\+\_\+fndnth (\begin{DoxyParamCaption}\item[{real (kind=real64), dimension (\+:), intent(in)}]{I\+N\+V\+A\+LS,  }\item[{integer, intent(in)}]{I\+N\+O\+RD }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\item 
/home/urbanjs/venus/\+V600/github/\+F\+I\+X\+M\+E/\+M\+\_\+orderpack/src/\mbox{\hyperlink{M__orderpack__fndnth_8f90}{M\+\_\+orderpack\+\_\+fndnth.\+f90}}\end{DoxyCompactItemize}
