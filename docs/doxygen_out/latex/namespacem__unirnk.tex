...
\begin{DoxyCode}{0}
\DoxyCodeLine{591       \textcolor{keywordtype}{Integer (Kind=int32)}, \textcolor{keywordtype}{Dimension (:)}, \textcolor{keywordtype}{Intent (In)} :: XVALT}
...
\DoxyCodeLine{601       nval = min(\textcolor{keyword}{SIZE}(xvalt), \textcolor{keyword}{SIZE}(irngt))}
...
\DoxyCodeLine{617          \textcolor{keywordflow}{If} (xvalt(iind-\/1) < xvalt(iind)) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{648                \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Exit}}
...
\DoxyCodeLine{670             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) cycle}
\DoxyCodeLine{671 \textcolor{comment}{!}}
\DoxyCodeLine{672 \textcolor{comment}{!   1 3 x x}}
\DoxyCodeLine{673 \textcolor{comment}{!}}
\DoxyCodeLine{674             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+1)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{675                irng2 = irngt(iwrkd+2)}
\DoxyCodeLine{676                irngt(iwrkd+2) = irngt(iwrkd+3)}
\DoxyCodeLine{677                \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{692                \textcolor{keywordflow}{If} (xvalt(irng1) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{693                   irngt(iwrkd+2) = irng1}
\DoxyCodeLine{694                   \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{744             xvala = xvalt(jwrkt(iinda))}
\DoxyCodeLine{745             xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{760                   xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{765                   xvala = xvalt(jwrkt(iinda))}
...
\DoxyCodeLine{786         xtst = nearless(min(xvalt(jwrkt(1)), xvalt(irngt(iindb))))}
\DoxyCodeLine{787       \textcolor{keywordflow}{Else}}
\DoxyCodeLine{788         xtst = nearless(xvalt(jwrkt(1)))}
...
\DoxyCodeLine{796                \textcolor{keywordflow}{If} (xvalt(jwrkt(iinda)) > xvalt(irngt(iindb))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{816          \textcolor{keywordflow}{If} (xvalt(irng) > xtst) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{817             xtst = xvalt(irng)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{345 \textcolor{keywordtype}{      Real} (Kind=real32), \textcolor{keywordtype}{Dimension (:)}, \textcolor{keywordtype}{Intent (In)} :: xvalt}
...
\DoxyCodeLine{355       nval = min(\textcolor{keyword}{SIZE}(xvalt), \textcolor{keyword}{SIZE}(irngt))}
...
\DoxyCodeLine{371          \textcolor{keywordflow}{If} (xvalt(iind-\/1) < xvalt(iind)) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{402                \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Exit}}
\DoxyCodeLine{403 \textcolor{comment}{!}}
\DoxyCodeLine{404 \textcolor{comment}{!   1 3 2}}
\DoxyCodeLine{405 \textcolor{comment}{!}}
\DoxyCodeLine{406                \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+1)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{424             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) cycle}
\DoxyCodeLine{425 \textcolor{comment}{!}}
\DoxyCodeLine{426 \textcolor{comment}{!   1 3 x x}}
\DoxyCodeLine{427 \textcolor{comment}{!}}
\DoxyCodeLine{428             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+1)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{429                irng2 = irngt(iwrkd+2)}
\DoxyCodeLine{430                irngt(iwrkd+2) = irngt(iwrkd+3)}
\DoxyCodeLine{431                \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{446                \textcolor{keywordflow}{If} (xvalt(irng1) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{447                   irngt(iwrkd+2) = irng1}
\DoxyCodeLine{448                   \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{498             xvala = xvalt(jwrkt(iinda))}
\DoxyCodeLine{499             xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{514                   xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{519                   xvala = xvalt(jwrkt(iinda))}
...
\DoxyCodeLine{540         xtst = nearless(min(xvalt(jwrkt(1)), xvalt(irngt(iindb))))}
\DoxyCodeLine{541       \textcolor{keywordflow}{Else}}
\DoxyCodeLine{542         xtst = nearless(xvalt(jwrkt(1)))}
...
\DoxyCodeLine{550                \textcolor{keywordflow}{If} (xvalt(jwrkt(iinda)) > xvalt(irngt(iindb))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{570          \textcolor{keywordflow}{If} (xvalt(irng) > xtst) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{571             xtst = xvalt(irng)}
...
unirnk(3f) -\/ \mbox{[}orderpack\+:\+R\+A\+NK\+:U\+N\+I\+Q\+UE\mbox{]} ranks an array, with removal of duplicate entries (Merge\+Sort)\hypertarget{namespacem__unirnk_autotoc_md126}{}\doxysubsubsection{S\+Y\+N\+O\+P\+S\+IS}\label{namespacem__unirnk_autotoc_md126}
...
C\+C0-\/1.\+0 
\begin{DoxyCode}{0}
\DoxyCodeLine{99 \textcolor{keywordtype}{      Real} (Kind=real64), \textcolor{keywordtype}{Dimension (:)}, \textcolor{keywordtype}{Intent (In)} :: xvalt}
...
\DoxyCodeLine{109       nval = min(\textcolor{keyword}{SIZE}(xvalt), \textcolor{keyword}{SIZE}(irngt))}
...
\DoxyCodeLine{125          \textcolor{keywordflow}{If} (xvalt(iind-\/1) < xvalt(iind)) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{156                \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Exit}}
\DoxyCodeLine{157 \textcolor{comment}{!}}
\DoxyCodeLine{158 \textcolor{comment}{!   1 3 2}}
\DoxyCodeLine{159 \textcolor{comment}{!}}
\DoxyCodeLine{160                \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+1)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{178             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+2)) <= xvalt(irngt(iwrkd+3))) cycle}
\DoxyCodeLine{179 \textcolor{comment}{!}}
\DoxyCodeLine{180 \textcolor{comment}{!   1 3 x x}}
\DoxyCodeLine{181 \textcolor{comment}{!}}
\DoxyCodeLine{182             \textcolor{keywordflow}{If} (xvalt(irngt(iwrkd+1)) <= xvalt(irngt(iwrkd+3))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{183                irng2 = irngt(iwrkd+2)}
\DoxyCodeLine{184                irngt(iwrkd+2) = irngt(iwrkd+3)}
\DoxyCodeLine{185                \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{200                \textcolor{keywordflow}{If} (xvalt(irng1) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{201                   irngt(iwrkd+2) = irng1}
\DoxyCodeLine{202                   \textcolor{keywordflow}{If} (xvalt(irng2) <= xvalt(irngt(iwrkd+4))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{252             xvala = xvalt(jwrkt(iinda))}
\DoxyCodeLine{253             xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{268                   xvalb = xvalt(irngt(iindb))}
...
\DoxyCodeLine{273                   xvala = xvalt(jwrkt(iinda))}
...
\DoxyCodeLine{294         xtst = nearless(min(xvalt(jwrkt(1)), xvalt(irngt(iindb))))}
\DoxyCodeLine{295       \textcolor{keywordflow}{Else}}
\DoxyCodeLine{296         xtst = nearless(xvalt(jwrkt(1)))}
...
\DoxyCodeLine{304                \textcolor{keywordflow}{If} (xvalt(jwrkt(iinda)) > xvalt(irngt(iindb))) \textcolor{keywordflow}{Then}}
...
\DoxyCodeLine{324          \textcolor{keywordflow}{If} (xvalt(irng) > xtst) \textcolor{keywordflow}{Then}}
\DoxyCodeLine{325             xtst = xvalt(irng)}
