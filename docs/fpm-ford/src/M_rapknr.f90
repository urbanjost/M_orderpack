...
!!##SYNOPSIS
!!
!!     Subroutine ${KIND}_rapknr (XDONT, IRNGT, NORD)
!!
...
!!    rapknr = (rnkpar backwards)
!!
!!    This routine uses a pivoting strategy such as the one of finding
...
!!    temporary arrays, where it stores the indices of the values larger
