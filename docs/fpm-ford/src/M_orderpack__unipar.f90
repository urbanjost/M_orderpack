...
!    CC0-1.0
interface unipar
   module procedure real64_unipar, real32_unipar, int16_unipar, int32_unipar, int64_unipar  !, f_char_unipar
...
Subroutine int16_unipar (INVALS, IRNGT, NORD)
! __________________________________________________________
   Integer (kind=int16), Dimension (:), Intent (In) :: INVALS
   Integer, Dimension (:), Intent (Out) :: IRNGT
   Integer, Intent (InOut) :: NORD
! __________________________________________________________
   Integer (kind=int16) :: XPIV, XWRK, XWRK1, XMIN, XMAX, XPIV0
! __________________________________________________________
   Integer, Dimension (SIZE(INVALS)) :: ILOWT, IHIGT
   Integer :: NDON, JHIG, JLOW, IHIG, IWRK, IWRK1, IWRK2, IWRK3
   Integer :: IDEB, JDEB, IMIL, IFIN, NWRK, ICRS, IDCR, ILOW
...
Subroutine int64_unipar (INVALS, IRNGT, NORD)
! __________________________________________________________
   Integer (kind=int64), Dimension (:), Intent (In) :: INVALS
   Integer, Dimension (:), Intent (Out) :: IRNGT
   Integer, Intent (InOut) :: NORD
! __________________________________________________________
   Integer (kind=int64) :: XPIV, XWRK, XWRK1, XMIN, XMAX, XPIV0
! __________________________________________________________
   Integer, Dimension (SIZE(INVALS)) :: ILOWT, IHIGT
   Integer :: NDON, JHIG, JLOW, IHIG, IWRK, IWRK1, IWRK2, IWRK3
   Integer :: IDEB, JDEB, IMIL, IFIN, NWRK, ICRS, IDCR, ILOW
...
!
!
End Subroutine int64_unipar

end module M_orderpack__unipar
