...
Subroutine int8_unirnk (INVALS, IRNGT, NUNI)
...
! __________________________________________________________
      ...
      Integer :: LMTNA, LMTNC, IRNG, IRNG1, IRNG2
      Integer :: NVAL, IIND, IWRKD, IWRK, IWRKF, JINDA, IINDA, IINDB
      Integer (Kind=int8) :: XTST, XVALA, XVALB
!
!
      NVAL = Min (SIZE(INVALS), SIZE(IRNGT))
      NUNI = NVAL
...
Subroutine int16_unirnk (INVALS, IRNGT, NUNI)
...
! __________________________________________________________
      ...
      Integer :: LMTNA, LMTNC, IRNG, IRNG1, IRNG2
      Integer :: NVAL, IIND, IWRKD, IWRK, IWRKF, JINDA, IINDA, IINDB
      Integer (Kind=int16) :: XTST, XVALA, XVALB
!
!
      NVAL = Min (SIZE(INVALS), SIZE(IRNGT))
      NUNI = NVAL
...
Subroutine int64_unirnk (INVALS, IRNGT, NUNI)
...
! __________________________________________________________
      ...
      Integer :: LMTNA, LMTNC, IRNG, IRNG1, IRNG2
      Integer :: NVAL, IIND, IWRKD, IWRK, IWRKF, JINDA, IINDA, IINDB
      Integer (Kind=int64) :: XTST, XVALA, XVALB
!
!
      NVAL = Min (SIZE(INVALS), SIZE(IRNGT))
      NUNI = NVAL
